<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"/www/wwwroot/huatong.com/application/index/view/user/index.html";i:1560354828;s:57:"/www/wwwroot/huatong.com/application/index/view/head.html";i:1508807576;}*/ ?>
        ...
        <form action="<?php echo url('user/addbalance'); ?>" method="post">
            <article class="clearfix mt10 m-round g-pay-ment g-bank-ct">
                <ul id="ulBankList">
                    ...
                    <li paytype="paysapi_alipay" class="gray9" type="paysapi" style="width: 50%">
                        <a href="javascript:;" class="z-initsel"><img src="/codepay/img/alipay.jpg"><s></s></a>

                    </li>
                    <li paytype="paysapi_wxpay" class="gray9" type="paysapi" style="width: 50%">
            ...
            <input type="hidden" id="pay_type" value="paysapi_alipay" name="pay_type"> <!--值1表示支付宝默认-->

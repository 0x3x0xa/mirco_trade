<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"/www/wwwroot/huatong.com/application/index/view/user/cashlist.html";i:1508130768;s:57:"/www/wwwroot/huatong.com/application/index/view/head.html";i:1508807576;}*/ ?>
...
<a href="<?php echo url('user/index'); ?>"  class="iconfont icon--8 tabnone tab-item tab-item-active" style=""><span class="tab-title ng-binding" >个人账户</span></a>
    ...
    <ion-content class="personalbg scroll-content ionic-scroll scroll-content-false  has-header has-tabs" scroll="false">
        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
         <div class="user_btn">
            <h5>提现金额：<?php echo $vo['bpprice']; ?></h5>
            <h5>状态：

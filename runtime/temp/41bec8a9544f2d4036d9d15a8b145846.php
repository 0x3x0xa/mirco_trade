<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:68:"/www/wwwroot/huatong.com/application/admin/view/order/orderinfo.html";i:1498579658;s:57:"/www/wwwroot/huatong.com/application/admin/view/head.html";i:1560350005;s:57:"/www/wwwroot/huatong.com/application/admin/view/menu.html";i:1508158368;s:57:"/www/wwwroot/huatong.com/application/admin/view/foot.html";i:1487579748;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
                      ...
                      <aside class="profile-nav alt green-border">
                          <section class="panel">
                              <div class="user-heading alt green-bg">
                                  ...
                                  <h1>用户名：<?php echo $nickname; ?></h1>
                                  <p>编号：<?php echo $username; ?></p>
                                  <p>余额：<?php if(isset($usermoney)): ?><?php echo $usermoney; else: ?>0<?php endif; ?></p>
                              </div>
                              ...
                              <div class="form-horizontal">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-6">
                                          <p class="control-label"><?php if($ostaus == 1): ?>平仓<?php else: ?>建仓<?php endif; ?></p>
                                      </div>
                                  </div>
									<hr>
                                  <div class="form-group">
                                      <label class="col-lg-2 control-label">入仓价格：</label>
                                      <div class="col-lg-6">
									...
									<hr>
                                  <div class="form-group">
                                      <label class="col-lg-2 control-label">平仓价格：</label>
                                      <div class="col-lg-6">
									...
									<hr>
                                  <div class="form-group">
                                      <label class="col-lg-2 control-label">入仓金额：</label>
                                      <div class="col-lg-6">
									...
									<hr>
                                  <div class="form-group">
                                      <label class="col-lg-2 control-label">入仓时间：</label>
                                      <div class="col-lg-6">
									...
									<hr>
                                  <div class="form-group">
                                      <label class="col-lg-2 control-label">平仓时间：</label>
                                      <div class="col-lg-6">
									...
									<hr>
                                  <div class="form-group">
                                      <label class="col-lg-2 control-label">本单盈亏：</label>
                                      <div class="col-lg-6">

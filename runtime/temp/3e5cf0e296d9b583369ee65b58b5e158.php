<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"/www/wwwroot/jiaxin.com/application/index/view/login/register.html";i:1560519486;s:56:"/www/wwwroot/jiaxin.com/application/index/view/head.html";i:1508807576;}*/ ?>
      ...
      <div class="sign_up_content">
          ...
          <ul class="sign_up_list">
				<li class="newinput" ng-show="show_signup_code">
                  ...
                  <input type="text" placeholder="姓名" name="username" class="nickname ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required" style="">
              </li>
              <!--<li class="newinput" ng-show="show_signup_code">
                  <span class="input-text">
                      手机号码:

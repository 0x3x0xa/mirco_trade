...
define('DB_USER', 'weipan');  //数据库用户名
define('DB_PWD', 'weipan888');//数据库密码
define('DB_NAME', 'weipan');  //数据库名称
 ...
 *
 */
define('DB_USERTABLE', 'wp_userinfo');  //充值用户所在数据库表名
define('DB_USERMONEY', 'usermoney');  //充值用户所在表中的金额字段名
